...
#Append a song to the my_playli
...
#if song is by artist return list of artist's songs 
...
#Create an empty list
#for each title in playlist loop over playlist
#if title is = song title 
#append the song 
#return list of songs titles
...
#if the the song title is = song title & song artist is = artist name
#favorite key = true
...
#create an empty list
#loop throught the playlist
#check the favorite key
#append song to favorites list
